...
router.get("/users/:id/subscription", controller.userSubscription);
router.post("/users/:id/subscription/disable", controller.disableUserAccess);
router.post("/users/:id/subscription/enable", controller.enableUserAccess);
router.post("/users/:id/subscription/extend", controller.extendUserAccess);
router.post("/users/:id/subscription/grant", controller.grantUserPlan);
router.get("/users/:id/content-access", controller.userContentAccess);
router.post("/users/:id/content-access/course/:courseId", controller.setCourseAccess);
router.post("/users/:id/content-access/topic/:topicId", controller.setTopicAccess);
router.post("/users/:id/content-access/course/:courseId/extend", controller.extendCourseAccess);
router.post("/users/:id/content-access/topic/:topicId/extend", controller.extendTopicAccess);
